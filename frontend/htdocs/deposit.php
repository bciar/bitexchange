...
<style type="text/css" data-styled-components="djoBUG ibMGEK rYbIC eDMnxP" data-styled-components-is-local="true">
  ...
  .rYbIC {
    ...
    margin: 6px 0px;
    margin-right: -1px;
    border-right: 1px dashed #2f3340;
  }
</style>
...
.dummy:after{
      border-bottom: 1px solid #0366d0 !important;
}
.dummy .kxlzLR {
    fill: #1166d1;
}
...
?>
                        ...
                        <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">Amount
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                        ...
                        <!-- <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;"> Description
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                  ...
                  <div class="Panel__Container-hCUKEb ejcVRF">
                    <div class="Accounts__Header-kUlsOz hjYHLC Flex__Flex-fVJVYW hQXxaf">
                      <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">
                        <span>Your USD Accounts
                        </span>
                        
                      </h4>
                      <span style="float:right">
                          <a href="javascript:void(0);" id="myBtn" class="gVLEBI dummy ">Add Deposit</a>
                          <a href="bank-accounts.php" class="gVLEBI dummy ">Manage accounts</a>
                        </span>
                    </div>
...
$d = date_create($request['date']);
        echo date_format($d, "M");?>
                                ...
                                <div class="Flex__Flex-fVJVYW jYOuLK">
                                  <div class="TransactionListItem__TransactionTitle-hrYDmM nDuUc Flex__Flex-fVJVYW iDqRrV">Deposit
                                  </div>
                                  <div class="TransactionListItem__TransactionSubtitle-CAWdv doKCBi Flex__Flex-fVJVYW reCYb">Using USD Wallet <?echo $request['status']; ?>
                                  </div>
                                </div>
                              </div>
                              <div class="TransactionListItem__AmountContainer-vrpLr dThaic Flex__Flex-fVJVYW gkSoIH">
                                ...
                                <div class="Flex__Flex-fVJVYW jvHpwe">
                                  <div class="TransactionListItem__TransactionSubtitle-CAWdv doKCBi Flex__Flex-fVJVYW iDqRrV">
                                    <span>
                                      <!-- <img src="https://png.icons8.com/small/50/000000/rupee.png" style="width:13px;"> -->
                                      <?echo (($CFG->currencies[$request['currency']]['is_crypto'] == 'Y') ? Stringz::currency($request['amount'], true) . ' ' . $request['fa_symbol'] : $request['fa_symbol'] . Stringz::currency($request['amount'])) ?>
                                    </span>
                                  </div>
                                </div>
                              </div>
...
?>
                       ...
                       <div class="Accounts__AccountListWrapper-hJZLkd fzpAGl Flex__Flex-fVJVYW iDqRrV">
                        <div class="AccountList__AccountsList-eEZOms jZdQTT Flex__Flex-fVJVYW gkSoIH">
                                  ...
                                  <div class="AccountListItem__Details-cWizxw GENJj Flex__Flex-fVJVYW bHipRv">
                                    ...
                                    <div class="AccountListItem__Actions-bsqZNF fNrJZo Flex__Flex-fVJVYW iDqRrV">
                                      <div class="Flex__Flex-fVJVYW ghkoKS">
                                        <button   onclick="location.href='deposit.php'"  class="myBtn AccountActionButtons__AccountButton-ejRNLb hOLrOE Button__Container-hQftQV gVLEBI dummy" id="deposite">
                                          <div class="Button__Content-eaBvLU iOGmBb Flex__Flex-fVJVYW iDqRrV">
                                        ...
                                        <button  onclick="location.href='withdraw.php'" class="AccountActionButtons__AccountButton-ejRNLb hOLrOE Button__Container-hQftQV gVLEBI" id="withdraw">
                                          <div class="Button__Content-eaBvLU iOGmBb Flex__Flex-fVJVYW iDqRrV">
                          ...
                          <div class="deposit-descp" style="padding: 5px 15px;margin-bottom: 3em;">
                            <h3>
                              <u>
                                <?=Lang::string('deposit-fiat-instructions')?>
                              </u>
                            </h3>
                            <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                              <div>
                        ...
                        <!-- <div class="Accounts__FooterLink-bzmsMV kjoxfT Flex__Flex-fVJVYW hBrjIA" >
                            <div onclick="location.href='bank-accounts.php'" style="margin-right: 5px;">
